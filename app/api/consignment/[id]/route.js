...
//         airwayBillId: data.airwayBill?.id,
//         goodsDeclarationId: data.goodsDeclaration.id,
//         customClearanceId: data.customClearance?.id,
//         packingId: data.packing?.id,
//         recoveryDoneId: data.recoveryDone?.id,
//         localInvoiceWeight: data.localInvoiceWeight,
//         dailyExpenses: parseFloat(data?.dailyExpenses),
//         status: data?.status,
//       },
//     });
