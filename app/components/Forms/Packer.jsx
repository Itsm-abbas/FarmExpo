  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: id
          ? "Packer details have been updated."
          : "New packer has been registered.",
      ...
      if (!id) {
        ...
        setTimeout(() => {
          router.push("/consignment/packer/view-packer");
        }, 1000);
      }
    } catch (error) {
      Swal.fire({
    ...
    >
      ...
      <motion.div variants={itemVariants} className="text-center">
        <LinkButton
          ...
          title="View All Packers"
          icon={FaEye}
          desc="Browse and manage your existing packing service providers"
        />
      </motion.div>
      ...
      >
        <h3 className="font-semibold font-poppins text-text mb-3 flex items-center space-x-2">
          ...
          <span>Packer Guidelines</span>
        </h3>
        <ul className="text-sm font-inter text-text/70 space-y-2">
          <li>• Fields marked with * are required for business registration</li>
          <li>• Ensure NTN number is accurate for tax compliance</li>
          <li>• Provide complete address for shipping coordination</li>
          <li>• Specify station for operational logistics</li>
